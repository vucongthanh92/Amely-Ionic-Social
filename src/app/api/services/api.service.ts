...
export class ApiService extends BaseService {
   ...
   * @param body - undefined
   */
  createOfferResponse(body: Param_create_offer): Observable<HttpResponse<DefaultResponse>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
   ...
   * @param body - undefined
   */
  createOffer(body: Param_create_offer): Observable<DefaultResponse> {
  ...
  /**
   */
  getOrdersResponse(): Observable<HttpResponse<inline_response_200_12>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    let req = new HttpRequest<any>(
  ...
  /**
   */
  getOrders(): Observable<inline_response_200_12> {
   ...
   * @param body - undefined
   */
  createOrderResponse(body: Param_create_order): Observable<HttpResponse<inline_response_200_11>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
   ...
   * @param body - undefined
   */
  createOrder(body: Param_create_order): Observable<inline_response_200_11> {
   ...
   * @param guid - Global Unique IDentity
   */
  getProductResponse(guid: number): Observable<HttpResponse<inline_response_200_13>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    if (guid != null) __params = __params.set("guid", guid.toString());
   ...
   * @param guid - Global Unique IDentity
   */
  getProduct(guid: number): Observable<inline_response_200_13> {
   ...
   * @param body - undefined
   */
  getProductsResponse(body: body_46): Observable<HttpResponse<inline_response_200_14>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
   ...
   * @param body - undefined
   */
  getProducts(body: body_46): Observable<inline_response_200_14> {
   ...
   * @param body - undefined
   */
  updateProfileResponse(body: body_48): Observable<HttpResponse<inline_response_200_15>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
   ...
   * @param body - undefined
   */
  updateProfile(body: body_48): Observable<inline_response_200_15> {
   ...
   */
  getPromotionResponse(promotionGuid: number): Observable<HttpResponse<inline_response_200_16>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @param promotion_guid - Global Unique IDentity
   */
  getPromotion(promotionGuid: number): Observable<inline_response_200_16> {
   ...
   * @param body - undefined
   */
  getPromotionsResponse(body: body_50): Observable<HttpResponse<inline_response_200_17>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
   ...
   * @param body - undefined
   */
  getPromotions(body: body_50): Observable<inline_response_200_17> {
   ...
   */
  searchResponse(q: string): Observable<HttpResponse<inline_response_200_18>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @param q - Global Unique IDentity
   */
  search(q: string): Observable<inline_response_200_18> {
   ...
   * @param order_guid - Global Unique IDentity
   */
  getShopOrderResponse(orderGuid?: number): Observable<HttpResponse<inline_response_200_19>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    if (orderGuid != null) __params = __params.set("order_guid", orderGuid.toString());
   ...
   * @param order_guid - Global Unique IDentity
   */
  getShopOrder(orderGuid?: number): Observable<inline_response_200_19> {
   ...
   * @param order_guid - Global Unique IDentity
   */
  getShopShippingResponse(orderGuid?: number): Observable<HttpResponse<inline_response_200_20>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    if (orderGuid != null) __params = __params.set("order_guid", orderGuid.toString());
   ...
   * @param order_guid - Global Unique IDentity
   */
  getShopShipping(orderGuid?: number): Observable<inline_response_200_20> {
   ...
   */
  getFriendlyShopResponse(): Observable<HttpResponse<inline_response_200_21>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    let req = new HttpRequest<any>(
   ...
   * get all shop friendly
   */
  getFriendlyShop(): Observable<inline_response_200_21> {
